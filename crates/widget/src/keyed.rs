...
//! changes slightly.
//!
//! Continuity is tricky in `icy_ui` and the Elm Architecture because
...
//! for `icy_ui`. If you have a list of things, adding an element at the
...
//! continuity. `icy_ui` already does this.
//!
...
/// use icy_ui::widget::keyed_column;
///
/// enum Message {
///     // ...
/// }
